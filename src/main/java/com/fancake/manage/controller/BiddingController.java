...
import com.fancake.manage.service.BiddingService;
...
public class BiddingController {
    ...
    private final BiddingService service; //final로 선언
    @GetMapping("/")
    public String index(){
    ...
    public void view(int mbno, @ModelAttribute("requestDTO") PageRequestDTO requestDTO, Model model){
        ...
        log.info("mbno :"+mbno);
        BiddingDTO dto=service.view(mbno);
    ...
    public String registerPost(BiddingDTO dto, RedirectAttributes redirectAttributes)
    {
        log.info("dto-----"+dto );
