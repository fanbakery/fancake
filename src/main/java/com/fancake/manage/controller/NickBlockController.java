...
import com.fancake.manage.service.NickBlockService;
...
@Controller
@RequestMapping("/nickblock")
@Log4j2
@RequiredArgsConstructor //자동 주입을 위한 Annotation
public class NickBlockController {

    private final NickBlockService service; //final로 선언
    @GetMapping("/")
    public String index(){

        return "redirect:/nickblock/list";
    }
    ...
    public void view(int mbno, @ModelAttribute("requestDTO") PageRequestDTO requestDTO, Model model){
        ...
        log.info("mbno :"+mbno);
        NickBlockDTO dto=service.view(mbno);
    ...
    public String registerPost(NickBlockDTO dto, RedirectAttributes redirectAttributes)
    {
        log.info("dto-----"+dto );
