...
public class SeenController {
    ...
    private final SeenService service; //final로 선언
    @GetMapping("/")
    public String index(){
        return "redirect:/seen/list";
    }
    ...
    public String registerPost(SeenDTO dto, RedirectAttributes redirectAttributes)
    {
        log.info("dto-----"+dto );
