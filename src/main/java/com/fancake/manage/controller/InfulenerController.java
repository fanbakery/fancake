...
import com.fancake.manage.service.InfluenceService;
...
public class InfulenerController {

    private final InfluenceService service; //final로 선언
    @GetMapping("/")
    public String index(){
        return "redirect:/influence/list";
    }
    ...
    public void view(int mbno, @ModelAttribute("requestDTO") PageRequestDTO requestDTO, Model model){
        ...
        log.info("mbno :"+mbno);
        InfluenceDTO dto=service.view(mbno);
