...
import com.fancake.manage.service.PayService;
...
public class PayController {
    ...
    private final PayService service; //final로 선언
    @GetMapping("/")
    public String index(){
    ...
    public String registerPost(PayDTO dto, RedirectAttributes redirectAttributes)
    {
        log.info("dto-----"+dto );
